...
export default defineConfig({
  title: "PoolMe",
  description:
    "A production-ready Go worker pool library with generics support",
  // Use CI env var which is guaranteed to be true in GitHub Actions
  base: process.env.CI ? "/poolme/" : "/",
